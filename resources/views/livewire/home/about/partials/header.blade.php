    ...
    <div class="container">
      <div class="row justify-content-center">
       ...
       {{--    <div id="typed-strings">
          ...
          <p class="lead mb-4 text-white opacity-8">Empresa creada para ser una de las numero uno en el mundo</p>
          <a  href="{{ url('/register') }}" type="submit" class="btn bg-white text-dark">Crear Cuenta</a>
          <h6 class="text-white mb-2 mt-5">Nuestras Redes Sociales</h6>
  ...
  <div class="container">
   {{--  <div class="row mb-7">
    ...
    <div class="row justify-content-center text-center">
      <div class="col-md-3">
        <h1 class="text-gradient text-info" id="state1" countTo="5234">5500</h1>
        <h5>Proyectos</h5>
        <p>De nivel “alto rendimiento” están dirigidos por un gerente de proyecto certificado</p>
      </div>
      <div class="col-md-3">
        <h1 class="text-gradient text-info"><span id="state2" countTo="3400">3400</span>+</h1>
        <h5>Horas</h5>
        <p>Que cumpla con los estándares de calidad requeridos por nuestros usuarios</p>
      </div>
      <div class="col-md-3">
        <h1 class="text-gradient text-info"><span id="state3" countTo="24">24</span>/7</h1>
        <h5>Soporte</h5>
        <p>Involucre activamente a los miembros del equipo para que terminen a tiempo.</p>
      </div>
    </div>
  </div>
</section>
        ...
        <div class="row justify-content-start">
          ...
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Funcionalidad de pagos</h5>
              <p>Estamos haciendo que sea posible pagar con todas las pasarelas de pago del mercado</p>
            </div>
          </div>
        </div>
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Componentes prediseñados</h5>
              <p>Trabajamos en la experiencia de usuario.</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Plataforma mejorada</h5>
              <p>Utilizamos los mejores frameworks del mercado para un mejor rendimiento en la web</p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-4 ms-auto mt-lg-0 mt-4">
        <div class="card shadow-lg">
          ...
          <div class="card-body">
            ...
            <p>
             Nuestros trabajadores estan mejorando dia a dia la web para una mejor rendimiento y experiencia 
            </p>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 m-auto">
        <h4>Se el primero en enterarte de las ultimas novedades</h4>
        <p class="mb-4">
         Registrate y no te pierdas de las ultimas novedades que estamos ofreciendo
        </p>
        <div class="row">
          <div class="col-8">
      ...
      <div class="col-md-5 ms-auto">
        <div class="position-relative">
          <img class="max-width-50 w-100 position-relative z-index-2" src="../assets/img/illustrations/sign-up.png"
            alt="image">
        </div>
      </div>
    </div>
