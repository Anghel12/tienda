      ...
      <div class="card position-relative border-0">
        ...
        <div class="overflow-auto scrollbar" style="height: 10rem;">
          <ul class="nav d-flex flex-column mb-2 pb-1">
            <li class="nav-item"><a class="nav-link px-3" href="{{ route('admin.profile.show', Auth::user()->id ) }}"> <span class="me-2 text-900" data-feather="user"></span><span>{{ Auth::user()->name }}</span></a></li>
           
            @if(auth()->user()->hasRole('Admin'))
            <li class="nav-item"><a class="nav-link px-3" href="{{ route('user_actions.wallets.index') }}"><span class="me-2 text-900" data-feather="pie-chart"></span>Cartera: {{ $userBalance }} </a></li>
            ...
            <li class="nav-item"><a class="nav-link px-3" href="{{ route('admin.posts.index') }}"> <span class="me-2 text-900" data-feather="lock"></span>Posts</a></li>
