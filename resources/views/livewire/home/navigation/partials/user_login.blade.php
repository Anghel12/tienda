...
<li class="nav-item dropdown dropdown-hover mx-2">
  ...
  <a class="" href="{{ route('admin.profile.show', Auth::user()->id ) }}" id="dropdownMenuAccount" data-bs-toggle="dropdown" aria-expanded="false">
  <img class="rounded-circle h-100 w-60 shadow-none border border-dark" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" /> 
{{-- <i class="fas fa-user " style="color: #2063b9;"></i> {{ Auth::user()->name }}
