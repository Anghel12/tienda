        ...
        <div class="col-lg-6 col-sm-9 text-center mx-auto mb-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-5 text-start ps-0">
              <button type="button" class="btn bg-gradient-info w-100 mb-0 h-100">Search issue</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="accordion-item mb-3">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
              ...
              <div class="accordion-body text-sm opacity-8">
                ...
                If everything I did failed - which it doesn't, it actually succeeds - just the fact that I'm willing
                to fail is an inspiration. People are so scared to lose that they don't even try. Like, one thing
                people can't say is that I'm not trying, and I'm not trying my hardest, and I'm not trying to do the
                best way I know how.
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  <button type="submit" class="btn bg-gradient-dark mt-4">Send Message</button>
                </div>
              </div>
            </div>
          </form>
  ...
  <div class="container position-relative z-index-1">
    <div class="row">
      <div class="col-lg-4 me-auto mb-lg-0 mb-4 text-lg-start text-center">
        <h6 class="text-white font-weight-bolder text-uppercase mb-3">Soft</h6>
        <ul class="nav flex-row ms-n3 justify-content-lg-start justify-content-center mb-5 mt-sm-0">
          <li class="nav-item">
