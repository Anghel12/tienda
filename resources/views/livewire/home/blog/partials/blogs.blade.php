<header>
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 px-sm-1 mt-md-0 mt-4">
                <div class="info-horizontal bg-light border-radius-xl p-5">
                  <div class="icon">
                    <svg class="text-primary" width="25px" height="25px" viewBox="0 0 46 43" version="1.1"
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-6 px-sm-1 mt-md-0 mt-4">
                <div class="info-horizontal info-horizontal bg-gradient-info border-radius-xl p-5">
                  <div class="icon">
                    <svg width="25px" height="25px" viewBox="0 0 44 43" version="1.1" xmlns="http://www.w3.org/2000/svg"
                      xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div class="min-vh-75 position-absolute w-100 top-0">
        <a class="carousel-control-prev" href="blog-posts.html#carouselExampleControls" role="button"
          data-bs-slide="prev">
          <span class="carousel-control-prev-icon position-absolute bottom-50" aria-hidden="true"></span>
          <span class="visually-hidden">Previous</span>
        </a>
        <a class="carousel-control-next" href="blog-posts.html#carouselExampleControls" role="button"
          data-bs-slide="next">
          ...
          <div class="card card-plain card-blog mt-5">
            <div class="row">
              ...
              <div class="col-lg-7 col-md-7 my-sm-auto mt-3 ms-sm-3">
                ...
                <p>
                  If you’ve ever wanted to train a machine learning model and integrate it with IFTTT, a new offering
                  from MateLabs. MateVerse, a platform where novices can spin out machine... <a href="javascript:;">
                    Read More </a>
                </p>
                <div class="author">
        ...
        <div class="card card-blog card-background">
          ...
          <div class="card-body body-left">
            <div class="content-left text-start">
              ...
              <p class="card-description">Rather than worrying about switching offices every couple years, you can
                instead stay in the same location and grow-up from your shared coworking space to an office that takes
                up an entire floor.</p>
              <div class="author">
    ...
    <div class="container position-relative mt-8">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-8 ms-md-auto">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mt-3">
              <select class="form-control" name="language-button" id="language-select">
            ...
            <li class="nav-item mt-3">
              <select class="form-control" name="currency-button" id="currency-select">
      ...
      <div class="row">
        <div class="col-lg-6 text-start mb-lg-0 mb-3">
          ...
          <p class="text-white opacity-8 mb-0">The latest news, articles and resources sent to your inbox weekely.</p>
        </div>
        <div class="col-lg-4 ms-auto text-end my-auto">
          <div class="row">
            ...
            <div class="col-md-4 col-5 text-start ps-0">
              <button type="button" class="btn bg-gradient-info mb-0 h-100">Subscribe</button>
            </div>
          </div>
        </div>
      </div>
