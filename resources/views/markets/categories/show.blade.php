<x-app-layout>
  ...
  <div class="bg-mod-black" style="width: 100%">
    <div class="container-fluid" style="height: 100%; padding-top: 7rem;">
      ...
      {{--   @livewire('product-filters.product-filter-component')
 --}}



        @include('markets.categories.partials.filters') 
     ...
     {{--      @include('markets.products.partials.cel_filtro') --}}
          ...
          @include('markets.categories.partials.adsend') 
        @if ($products_by_category->count() > 0)
        @include('markets.categories.partials_c.products')
        @else

        @endif
        @include('markets.categories.partials.adsend') 
         @include('markets.categories.partials.populares') 
