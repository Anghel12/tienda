            ...
            <div class="card-footer text-center pt-0 px-sm-4 px-1">
              <div class="row px-xl-5 px-sm-4 px-3">
                ...
                <div class="col-3 me-auto px-1"> 
                  <a class="btn btn-outline-light w-100 p-3" href="{{route('google-auth')}}">
                    <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <p class="mb-0 mt-3 text-sm mx-auto">
                No tengo una Cuenta?
                <a href="{{ $register_url }}" class="text-info text-gradient font-weight-bold">Registarse</a>
              </p>
              <p class="mb-0 mt-3 text-sm mx-auto">
                Olvidaste tu Contraseña?
                <a href="{{ $password_reset_url }}" class="text-info text-gradient font-weight-bold">Recuperar</a>
              </p>
