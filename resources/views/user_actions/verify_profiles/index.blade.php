...
<div class="container ">
    <div class="row justify-content-center align-items-center" style="height: 80vh; padding-top: 7rem;">
        ...
        <div
            ...
            <h1 class="text-white pt-3 mt-n5">Verificar Mi Cuenta</h1>
            <p class="lead text-white mt-3">
                Para mejorar la experiencia del usuario y tener mas seguridad
            </p>
        </div>
                      ...
                      <div class="card-header p-4 border-bottom border-300 bg-soft">
                        <div class="row g-3 justify-content-between align-items-center">
                          <div class="col-12 col-md">
                            <h4 class="text-900 mb-0" data-anchor="data-anchor">Verificar Mi Cuenta </h4>
                          </div>
                          ...
                          <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                            <div class="card-header bg-100 pt-3 pb-2 border-bottom-0">
                              <ul class="nav justify-content-between nav-wizard" role="tablist">
                                <li class="nav-item" role="presentation"><a class="nav-link active fw-semi-bold" href="wizard.html#bootstrap-wizard-tab1" data-bs-toggle="tab" data-wizard-step="1" aria-selected="true" role="tab">
                                ...
                                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold" href="wizard.html#bootstrap-wizard-tab2" data-bs-toggle="tab" data-wizard-step="2" aria-selected="false" tabindex="-1" role="tab">
                                ...
                                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold" href="wizard.html#bootstrap-wizard-tab3" data-bs-toggle="tab" data-wizard-step="3" aria-selected="false" tabindex="-1" role="tab">
                                ...
                                <li class="nav-item" role="presentation"><a class="nav-link fw-semi-bold" href="wizard.html#bootstrap-wizard-tab4" data-bs-toggle="tab" data-wizard-step="4" aria-selected="false" tabindex="-1" role="tab">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" aria-labelledby="bootstrap-wizard-tab1" id="bootstrap-wizard-tab1">
                                  <form id="wizardForm1" novalidate="novalidate" data-wizard-form="1">
                                    ...
                                    <div class="form-check"><input class="form-check-input" type="checkbox" name="terms" checked="checked" id="bootstrap-wizard-wizard-checkbox"><label class="form-check-label text-900" for="bootstrap-wizard-wizard-checkbox">I accept the <a href="wizard.html#!">terms </a>and <a href="wizard.html#!">privacy policy</a></label></div>
                                  </form>
                                </div>
