    ...
    <div class="container ">
        <div class="row justify-content-center align-items-center" style="height: 80vh; padding-top: 7rem;">
            ...
            <div class="col-lg-12 col-12 text-center d-flex flex-column justify-content-center align-items-center mb-3 mb-lg-0">
              <h1 class="text-white pt-3 mt-n5">Transferir Coins</h1>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                  <label class="" for="email"> <h7>Email del destinatario:</h7> </label>
                                    <input type="email" name="email" class="form-control form-control-alternative" id="email">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-12">
                                <div class="form-group has-success">
                                  <label class="" for="email"> <h7>Cantidad:</h7> </label>
                                    <input type="number" name="amount" class="form-control form-control-alternative " value="0" />
                                </div>
                            </div>
                        </div>
