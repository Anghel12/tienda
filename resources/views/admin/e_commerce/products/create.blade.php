    ...
    <div class="content">
        <nav class="mb-2" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="add-product.html#!">Page 1</a></li>
            <li class="breadcrumb-item"><a href="add-product.html#!">Page 2</a></li>
            ...
            <div class="col-12 col-xl-8">
              ...
              <div class="dropzone dropzone-multiple p-0 mb-5" id="my-awesome-dropzone" data-dropzone="data-dropzone">
                ...
                <div class="dz-preview d-flex flex-wrap">
                  <div class="border bg-white rounded-3 d-flex flex-center position-relative me-2 mb-2" style="height:80px;width:80px;"><img class="dz-image" src="../../../assets/img/products/23.png" alt="..." data-dz-thumbnail="data-dz-thumbnail" /><a class="dz-remove text-400" href="add-product.html#!" data-dz-remove="data-dz-remove"><span data-feather="x"></span></a></div>
                </div>
                  ...
                  <div class="tab-content py-3 ps-sm-4 h-100">
                    ...
                    <div class="tab-pane fade h-100" id="shippingTabContent" role="tabpanel" aria-labelledby="shippingTab">
                      <div class="d-flex flex-column h-100">
                        ...
                        <p class="fs--1 fw-semi-bold mb-0">See our <a class="fw-bold" href="add-product.html#!">Delivery terms and conditions </a>for details.</p>
                      </div>
                    </div>
                    <div class="tab-pane fade" id="productsTabContent" role="tabpanel" aria-labelledby="productsTab">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="ps-4">
                          <p class="fs--1 mb-0 text-800">Only available with Shipping method: <a href="add-product.html#!">Fullfilled by Phoenix</a></p>
                        </div>
                      </div>
                      <div class="mb-3">
                      ...
                      <div>
                        ...
                        <p class="fs--1 ms-4 mb-0 text-800">Deliver to your country of residence <a href="add-product.html#!">Change profile address </a></p>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row gx-3">
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="mb-4">
                            <div class="d-flex flex-wrap mb-2">
                              <h5 class="mb-0 text-1000 me-2">Category</h5><a class="fw-bold fs--1" href="add-product.html#!">Add new category</a>
                        ...
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="mb-4">
                            <div class="d-flex flex-wrap mb-2">
                              <h5 class="mb-0 text-1000 me-2">Vendor</h5><a class="fw-bold fs--1" href="add-product.html#!">Add new vendor</a>
                            </div><select class="form-select mb-3" aria-label="category">
                              <option value="men-cloth">Men's Clothing</option>
                              <option value="women-cloth">Womens's Clothing</option>
                              <option value="kid-cloth">Kid's Clothing</option>
                        ...
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="d-flex flex-wrap mb-2">
                            <h5 class="mb-0 text-1000 me-2">Tags</h5><a class="fw-bold fs--1 lh-sm" href="add-product.html#!">View all tags</a>
                      ...
                      <div class="row g-3">
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="border-bottom border-dashed border-sm-0 border-bottom-xl pb-4">
                            <div class="d-flex flex-wrap mb-2">
                              <h5 class="text-1000 me-2">Option 1</h5><a class="fw-bold fs--1" href="add-product.html#!">Remove</a>
                        ...
                        <div class="col-12 col-sm-6 col-xl-12">
                          <div class="d-flex flex-wrap mb-2">
                            <h5 class="text-1000 me-2">Option 2</h5><a class="fw-bold fs--1" href="add-product.html#!">Remove</a>
                          </div><select class="form-select mb-3">
                            <option value="size">Size</option>
                            <option value="color">Color</option>
                            <option value="weight">Weight</option>
