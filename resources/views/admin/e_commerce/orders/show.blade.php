<x-guest-layout>
    <div class="mb-9">
        ...
        <div class="d-sm-flex flex-between-center mb-3">
          <p class="text-800 lh-sm mb-0 mt-2 mt-sm-0">Customer ID : <a class="fw-bold" href="order-details.html#!"> 2364847</a></p>
          <div class="d-flex"><button class="btn btn-link pe-3 ps-0 text-900"><span class="fas fa-print me-2"></span>Print</button><button class="btn btn-link px-3 text-900"><span class="fas fa-undo me-2"></span>Refund</button>
            <div class="dropdown"><button class="btn text-900 dropdown-toggle dropdown-caret-none ps-3 pe-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">More action<span class="fas fa-chevron-down ms-2"></span></button>
              <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="order-details.html#">Action</a></li>
                <li><a class="dropdown-item" href="order-details.html#">Another action</a></li>
                <li><a class="dropdown-item" href="order-details.html#">Something else here</a></li>
              </ul>
            </div>
          </div>
        </div>
                ...
                <table class="table fs--1 mb-0 border-top border-200">
                  ...
                  <tbody class="list" id="order-table-body">
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/1.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">Fitbit Sense Advanced Smartwatch with Tools for Heart Health, Stress Management &amp; Skin Temperature Trends, Carbon/Graphite, One Size (S &amp; L Bands)</a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/2.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">iPhone 13 pro max-Pacific Blue-128GB storage</a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/3.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">Apple MacBook Pro 13 inch-M1-8/256GB-space</a></td>
                      <td class="color align-middle white-space-nowrap text-900 py-0 ps-4">Glossy black</td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/4.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">Apple iMac 24&quot; 4K Retina Display M1 8 Core CPU, 7 Core GPU, 256GB SSD, Green (MJV83ZP/A) 2021</a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/5.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">Razer Kraken v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                    ...
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="align-middle white-space-nowrap py-2"><a class="d-block border rounded-2" href="../landing/product-details.html"><img src="https://prium.github.io/phoenix/v1.13.0/assets/img//products/6.png" alt="" width="53" /></a></td>
                      <td class="products align-middle py-0"><a class="fw-semi-bold line-clamp-2 mb-0" href="../landing/product-details.html">PlayStation 5 DualSense Wireless Controller</a></td>
              ...
              <div class="col-12 col-sm-auto">
                ...
                <div class="row g-4 flex-sm-column">
                  <div class="col-6 col-sm-12">
                    ...
                    </div><a class="fs--1 ms-4" href="order-details.html#!">Shatinon Mekalan</a>
                  </div>
                  <div class="col-6 col-sm-12">
