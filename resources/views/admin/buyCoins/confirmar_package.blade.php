            ...
            <div class="container-small">
              <nav class="mb-2" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                  <li class="breadcrumb-item"><a href="checkout.html#!">Page 1</a></li>
                  <li class="breadcrumb-item"><a href="checkout.html#!">Page 2</a></li>
                ...
                <div class="col-lg-7 col-xl-7">
                  <form>
                    ...
                    <div class="row gy-6">
                      <div class="col-12 col-md-6">
                        <div class="d-flex flex-wrap align-items-center mb-3">
                          <div class="form-check mb-0"><input class="form-check-input" type="radio" name="shippingRadio" id="free_shipping" /><label class="form-check-label fs-0 text-900" for="free_shipping">Free Shipping</label></div><span class="d-inline-block text-1100 fw-bold ms-2">$0.00</span>
                        </div>
                        <div class="ps-4">
                          <h6 class="text-700 mb-2">Est. delivery:Jun 21 – Jul 20</h6>
                          <h6 class="text-info lh-base mb-0">Get Free Shipped products in Time!</h6>
                        </div>
                      </div>
                      <div class="col-12 col-md-6">
                        <div class="d-flex flex-wrap align-items-center mb-3">
                          <div class="form-check mb-0"><input class="form-check-input" type="radio" name="shippingRadio" id="two_days_shipping" /><label class="form-check-label fs-0 text-900" for="two_days_shipping">Two days Shipping</label></div><span class="d-inline-block text-1100 fw-bold ms-2">$20.00</span>
                        </div>
                        <div class="ps-4">
                          <h6 class="text-700 mb-2">Est. delivery:Jun 21 – Jul 20</h6>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="d-flex flex-wrap align-items-center mb-3">
                          <div class="form-check mb-0"><input class="form-check-input" type="radio" name="shippingRadio" id="standard_shipping" /><label class="form-check-label fs-0 text-900" for="standard_shipping">Standard Shipping</label></div><span class="d-inline-block text-1100 fw-bold ms-2">$10.00</span>
                        </div>
                        <div class="ps-4">
                          <h6 class="text-700 mb-2">Est. delivery:Jun 21 – Jul 20</h6>
                      ...
                      <div class="col-12 col-md-6">
                        <div class="d-flex flex-wrap align-items-center mb-3">
                          <div class="form-check mb-0"><input class="form-check-input" type="radio" name="shippingRadio" checked="checked" id="one_day_shipping" /><label class="form-check-label fs-0 text-900" for="one_day_shipping">One day Shipping</label></div><span class="d-inline-block text-1100 fw-bold ms-2">$30.00</span><span class="badge badge-phoenix badge-phoenix-warning ms-2 ms-lg-4 ms-xl-2">Popular</span>
                        </div>
                        <div class="ps-4">
                          <h6 class="text-700 mb-2">Est. delivery:Jun 21 – Jul 20</h6>
                    ...
                    <div class="row g-4 mb-7">
                      <div class="col-12">
                        <div class="row gx-lg-11">
                          <div class="col-12 col-md-auto">
                            <div class="d-flex">
                              <div class="form-check"><input class="form-check-input" id="creditCard" type="radio" name="paymentMethod" checked="checked" /><label class="form-check-label fs-0 text-900 me-3" for="creditCard">Credit card</label></div><img class="h-100 me-2 ms-4 ms-md-0" src="../../../assets/img/logos/visa.png" alt="" /><img class="h-100 me-2" src="../../../assets/img/logos/discover.png" alt="" /><img class="h-100 me-2" src="../../../assets/img/logos/mastercard.png" alt="" /><img class="h-100" src="../../../assets/img/logos/american_express.png" alt="" />
                            </div>
                          </div>
                          <div class="col-12 col-md-auto">
                            <div class="form-check"><input class="form-check-input" id="paypal" type="radio" name="paymentMethod" /><label class="form-check-label fs-0 text-900" for="paypal">Paypal </label></div>
                          </div>
                          <div class="col-12 col-md-auto">
                            <div class="form-check"><input class="form-check-input" id="coupon" type="radio" name="paymentMethod" /><label class="form-check-label fs-0 text-900" for="coupon">Coupon </label></div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6"><label class="form-label fs-0 text-1000 ps-0 text-none" for="selectCard">Select card</label><select class="form-select text-black" id="selectCard">
                      ...
                      <div class="col-md-6"><label class="form-label fs-0 text-1000 ps-0 text-none" for="inputCardNumber">Card number</label><input class="form-control" id="inputCardNumber" type="number" placeholder="Enter card number" aria-label="Card number" /></div>
                      <div class="col-12"><label class="form-label fs-0 text-1000 ps-0 text-none" for="inputName">Full name</label><input class="form-control" id="inputName" type="text" placeholder="Ansolo Lazinatov" aria-label="Full name" /></div>
                      <div class="col-md-6"><label class="form-label fs-0 text-1000 ps-0 text-none">Expires on</label>
                      ...
                      <div class="col-md-6"><label class="form-label fs-0 text-1000 ps-0 text-none" for="inputCardCVC">CVC</label><input class="form-control" id="inputCardCVC" type="number" placeholder="Enter a valid CVC" aria-label="CVC" /></div>
                      <div class="col-12">
                        <div class="form-check"><input class="form-check-input" id="gridCheck" type="checkbox" /><label class="form-check-label text-black fs-0" for="gridCheck">Save Card Details</label></div>
                      </div>
                    </div>
