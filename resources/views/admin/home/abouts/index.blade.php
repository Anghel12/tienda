...
@section('content')
    <div class="card-minimalista">
        ...
        <div class="card-body">
            <table id="aboutsTable" class="table table-striped">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Título</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $about->miembro }}</td> <!-- Agrega el campo miembro -->
                        <td>
                            <a href="{{ url('/') }}" class="btn btn-sm btn-success">Ver</a>
                            <a href="{{ route('admin.home.abouts.edit', $about->id) }}" class="btn btn-sm btn-primary">Editar</a>
                            <form action="{{ route('admin.home.abouts.destroy', $about->id) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
