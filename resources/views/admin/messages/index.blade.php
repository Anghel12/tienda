    ...
    <div class="content pt-0">
        <div class="email-container">
          ...
          <div class="row g-lg-6 mb-8">
              ...
              <div class="email-sidebar email-sidebar-width bg-soft phoenix-offcanvas phoenix-offcanvas-fixed" id="emailSidebarColumn">
                <div class="email-content scrollbar-overlay">
                  ...
                  <ul class="nav flex-column border-top fs--1 vertical-nav mb-4">
                    ...
                    <li class="nav-item"><a class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none active" aria-current="page" href="inbox.html#!">
                  ...
                  <div class="d-flex justify-content-between">
                    <p class="text-uppercase fs--2 text-600 mb-2 fw-bold">Filtered</p><a class="fs--2 fw-bold" href="inbox.html#!"><span class="fa-solid fa-plus me-2"></span>Add Folder</a>
                  </div>
                  <ul class="nav flex-column border-top fs--1 vertical-nav mb-4">
                    <li class="nav-item"><a class="nav-link py-2 ps-0 pe-3 border-end border-bottom text-start outline-none" aria-current="page" href="inbox.html#!">
                  ...
                  <div class="d-flex justify-content-between">
                    <p class="text-uppercase fs--2 text-600 mb-2 fw-bold">Labels</p><a class="fs--2 fw-bold" href="inbox.html#!"><span class="fa-solid fa-plus me-2"></span>Add Label</a>
                  </div>
            ...
            <div class="col-lg">
              <div class="px-lg-1">
                <div class="d-flex align-items-center flex-wrap position-sticky pb-2 bg-soft z-index-2 email-toolbar inbox-toolbar">
                  ...
                  <div class="row align-items-sm-center gx-2">
                    ...
                    <div class="col-auto ms-auto">
                      <div class="hover-actions end-0"><button class="btn btn-phoenix-secondary btn-icon dropdown-toggle dropdown-caret-none" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fa-solid fa-ellipsis"></span></button>
                        <div class="dropdown-menu dropdown-menu-end py-2"><a class="dropdown-item" href="inbox.html#!">Mark Unread</a><a class="dropdown-item" href="inbox.html#!">Mark Important</a><a class="dropdown-item" href="inbox.html#!">Archive</a><a class="dropdown-item" href="inbox.html#!">Download</a><a class="dropdown-item" href="inbox.html#!">Print</a><a class="dropdown-item" href="inbox.html#!">Report Spam</a><a class="dropdown-item" href="inbox.html#!">Report Phishing</a><a class="dropdown-item" href="inbox.html#!">Mute Jessica Ball</a><a class="dropdown-item" href="inbox.html#!">Block Jessica Ball</a><a class="dropdown-item text-danger" href="inbox.html#!">Delete</a></div>
                ...
                <div class="border-top border-200 hover-actions-trigger py-3">
                  ...
                  <div class="ms-4 mt-n3 mt-sm-0 ms-sm-11"><a class="d-block inbox-link" href="email-detail.html"><span class="fs--1 line-clamp-1 text-1100">How to take the headache out of Order</span>
                    ...
                    </a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="inbox.html#!"><span class="fas fa-file-pdf text-warning fs--1"></span><span class="ms-2 fw-bold fs--2 text-900">Financial_Reports.pdf</span></a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="inbox.html#!"><span class="fas fa-file-zipper text-warning fs--1"></span><span class="ms-2 fw-bold fs--2 text-900">Frame20.zip</span></a></div>
                </div>
                <div class="border-top border-200 hover-actions-trigger py-3">
                  <div class="row align-items-sm-center gx-2">
                    <div class="col-auto">
                ...
                <div class="border-top border-200 hover-actions-trigger py-3">
                  ...
                  <div class="ms-4 mt-n3 mt-sm-0 ms-sm-11"><a class="d-block inbox-link" href="email-detail.html"><span class="fs--1 line-clamp-1 text-1000">How can I order something urgently?</span>
                    ...
                    </a><a class="d-inline-flex align-items-center border rounded-pill px-3 py-1 me-2 mt-2 inbox-link" href="inbox.html#!"><span class="fa-solid fa-music text-primary fs--1"></span><span class="ms-2 fw-bold fs--2 text-900">syllabus</span></a></div>
                </div>
