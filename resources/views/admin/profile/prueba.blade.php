...
<div class="mb-20">
  ...
  <div class="container">
    ...
    <div class="col-12 col-md-3 d-flex flex-column">
      <div class="card h-50 card-background align-items-start" id="wallet-card">
      ...
      <div class="card h-50 card-background align-items-start">
        <div class="full-background" style="background-image: url(https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/&)"></div>
        <div class="card-body z-index-3">
        <div class="icon icon-md">
      ...
      {{-- <a class="btn btn-primary" href="#">buscar usuario</a>  --}}
        </div>
        <span class="mask bg-gradient-info border-radius-xl z-index-2 opacity-6"></span>
        </div>
  ...
  <div class="row justify-content-center align-items-center" style="height: 100vh; padding-top: 7rem;">
    ...
    <section class="py-5">
      ...
      <div class="card-footer pb-3 pt-2 z-index-3">
        ...
        @if (isset($userBalance))
        <h4 class="text-white mb-1">BALANCE:</h4>
        <h2 class="text-white font-weight-bolder text-uppercase">$.{{ $userBalance }}</h2>
      ...
      <div class="card h-50 card-background mt-4 align-items-start">
      <div class="full-background" style="background-image: url(https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/&)"></div>
      <div class="card-body z-index-3">
      <div class="icon icon-md">
      <svg width="30px" height="30px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <h5 class="text-white mb-1">Verificar cuenta: 50%</h5>
      <p class="text-white text-xs font-weight-bolder text-uppercase"> <a class="btn btn-info text-white" href="{{ route('admin.verifies.index') }}">Completar</a> </p>
      </div>
      <span class="mask bg-gradient-info border-radius-xl z-index-2 opacity-6"></span>
      </div>
      </div>
      ...
      <div class="col-12 col-md-2 d-flex flex-column">
      <div class="card card-background align-items-start h-50">
      <div class="full-background" style="background-image: url(https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/&)"></div>
      <div class="card-body z-index-3">
      <div class="icon icon-md">
      <svg width="30px" height="30px" viewBox="0 0 52 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <div class="card-footer pb-3 pt-5 z-index-3">
      <h4 class="text-white mb-1">Monedas</h4>
      <p class="text-white text-xs font-weight-bolder text-uppercase"> <a class="btn btn-info text-white" href="{{ route('user_actions.buy_coins.index') }}">Depositar</a> </p>
    {{-- <a class="btn btn-primary" href="#">buscar usuario</a>  --}}
      </div>
      <span class="mask bg-gradient-info border-radius-xl z-index-2 opacity-6"></span>
      </div>
      ...
      <div class="card card-background mt-4 align-items-start h-50">
      <div class="full-background" style="background-image: url(https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/&)"></div>
      <div class="card-body z-index-3">
      <div class="icon icon-md">
      <svg width="30px" height="30px" viewBox="0 0 42 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    {{--   <span class="mask bg-gradient-primary border-radius-xl z-index-2 opacity-6"></span> --}}
      ...
      <div class="col-12 col-md-2 d-flex flex-column">
        <div class="card card-background align-items-start h-50" id="Tranferir_dinero">
        <div class="full-background" style="background-image: url(https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/&)"></div>
        <div class="card-body z-index-3">
        <div class="icon icon-md">
        <svg width="30px" height="30px" viewBox="0 0 52 35" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="card-footer pb-3 pt-5 z-index-3">
        <h4 class="text-white mb-1">TRANSFERIR</h4>
        <p class="text-white text-xs font-weight-bolder text-uppercase opacity-7">Facil y Rapido</p>
      {{-- <a class="btn btn-primary" href="#">buscar usuario</a>  --}}
        </div>
        <span class="mask bg-gradient-info border-radius-xl z-index-2 opacity-6"></span>
        ...
        <div class="card-footer pb-3 pt-2 z-index-3">
        <h4 class="text-white mb-1">Ordenes</h4>
        <p class="text-white text-xs font-weight-bolder text-uppercase opacity-7"></p> <a class="btn btn-info" href="{{ route('user_actions.history_transaccions.index') }}">Ver Historial</a>
        </div>
        <span class="mask bg-gradient-info border-radius-xl z-index-2 opacity-6"></span>
      {{--   <span class="mask bg-gradient-primary border-radius-xl z-index-2 opacity-6"></span> --}}
        </div>
