<x-guest-layout>
    ...
    <div class="content">
        <div class="row gy-3 mb-4 justify-content-between">
          <div class="col-xxl-6">
            <h2 class="mb-2 text-1100">CRM Dashboard</h2>
                ...
                <div class="row g-0">
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-primary" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Organic</span></div>
                  ...
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end-md-0 border-end-xl">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-success" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Paid Search</span></div>
                  ...
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-bottom border-end border-end-md border-end-xl-0">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-info" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Direct</span></div>
                  ...
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-end-xl border-bottom border-bottom-xl-0">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-info-300" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Social</span></div>
                  ...
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1 border-end">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-danger-200" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Referrals</span></div>
                  ...
                  <div class="col-6 col-xl-4">
                    <div class="d-flex flex-column flex-center align-items-sm-start flex-md-row justify-content-md-between flex-xxl-column p-3 ps-sm-3 ps-md-4 p-md-3 h-100 border-1">
                      <div class="d-flex align-items-center mb-1"><span class="fa-solid fa-square fs--3 me-2 text-warning-300" data-fa-transform="up-2"></span><span class="mb-0 fs--1 text-900">Others</span></div>
            ...
            <div class="row g-6">
              <div class="col-md-6 mb-2 mb-sm-0">
                <div class="d-flex align-items-center"><span class="me-2 text-info" data-feather="users" style="min-height:24px; width:24px"></span>
                  <h4 class="text-600 mb-0">New Users :<span class="text-1100"> 42</span></h4><span class="badge badge-phoenix fs--2 badge-phoenix-success d-inline-flex align-items-center ms-2"><span class="badge-label d-inline-block lh-base">+24.5%</span><span class="ms-1 fa-solid fa-caret-up d-inline-block lh-1"></span></span>
                </div>
                <div class="pb-0 pt-4">
              ...
              <div class="col-md-6">
                <div class="d-flex align-items-center"><span class="me-2 text-primary" data-feather="zap" style="height:24px; width:24px"></span>
                  <h4 class="text-600 mb-0">New Leads :<span class="text-1100">45</span></h4><span class="badge badge-phoenix fs--2 badge-phoenix-success d-inline-flex align-items-center ms-2"><span class="badge-label d-inline-block lh-base">+30.5%</span><span class="ms-1 fa-solid fa-caret-up d-inline-block lh-1"></span></span>
                </div>
                <div class="pb-0 pt-4">
          ...
          <div class="col-12 col-xxl-6 mb-6 gy-0 gy-xxl-3">
            ...
            <div class="w-100">
              ...
              <div class="progress mb-3 rounded-3" style="height: 10px;">
                <div class="progress-bar border-end border-white border-2" role="progressbar" style="width: 20.72%" aria-valuenow="20.72" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top" title="Appointment"></div>
                <div class="progress-bar bg-primary-300 border-end border-white border-2" role="progressbar" style="width: 35.76%" aria-valuenow="35.76" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top" title="Qualified"></div>
                <div class="progress-bar bg-success border-end border-white border-2" role="progressbar" style="width: 25.38%" aria-valuenow="25.38" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top" title="Closed Won"></div>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="sort border-end align-middle text-end px-3 text-uppercase text-700" scope="col" data-sort="appointment" style="width:15%; min-width:95px">
                        <div class="d-inline-flex flex-center"><span class="fa-solid fa-square fs--3 text-primary me-2" data-fa-transform="up-2"></span><span class="mb-0 fs--1">Appointment</span></div>
                      </th>
                      <th class="sort border-end align-middle text-end px-3 text-uppercase text-700" scope="col" data-sort="qualified" style="width:20%; min-width:100px">
                        <div class="d-inline-flex flex-center"><span class="fa-solid fa-square fs--3 text-primary-300 me-2" data-fa-transform="up-2"></span><span class="mb-0 fs--1">Qualified</span></div>
                      </th>
                      <th class="sort border-end align-middle text-end px-3 text-uppercase text-700" scope="col" data-sort="closed-won" style="width:20%; min-width:100px">
                        <div class="d-inline-flex flex-center"><span class="fa-solid fa-square fs--3 text-success me-2" data-fa-transform="up-2"></span><span class="mb-0 fs--1">Closed Won</span></div>
                      </th>
                      <th class="sort align-middle text-end ps-3 text-uppercase text-700" scope="col" data-sort="contact-sent" style="width:20%; min-width:100px">
                        <div class="d-inline-flex flex-center"><span class="fa-solid fa-square fs--3 text-info me-2" data-fa-transform="up-2"></span><span class="mb-0 fs--1">Contact Sent</span></div>
                      </th>
                    </tr>
                  </thead>
                  <tbody class="list" id="table-deal-forecast-body">
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Carrie Anne</a></td>
                      ...
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$1200</td>
                    </tr>
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Milind Mikuja</a></td>
                      ...
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$2200</td>
                    </tr>
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Stanley Drinkwater</a></td>
                      ...
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$100</td>
                    </tr>
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Josef Stravinsky</a></td>
                      ...
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$265</td>
                    </tr>
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Roy Anderson</a></td>
                      ...
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$865</td>
                    </tr>
                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                      <td class="contact border-end align-middle white-space-nowrap py-2 ps-0 px-3"><a class="fw-semi-bold" href="crm.html#!">Oscar Wilde</a></td>
                      <td class="appointment border-end align-middle white-space-nowrap text-end fw-semi-bold text-900 py-2 px-3">1020</td>
                      <td class="qualified border-end align-middle white-space-nowrap text-end fw-semi-bold text-900 py-2 px-3">$950</td>
                      <td class="closed-won border-end align-middle white-space-nowrap text-end fw-semi-bold text-900 py-2 px-3">$1000</td>
                      <td class="contact-sent border-end-0 align-middle white-space-nowrap text-end fw-semi-bold text-900 ps-3 py-2">$800</td>
                    </tr>
                  </tbody>
                  <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                    ...
                    <td class="border-bottom-0 align-middle white-space-nowrap text-end fw-bold text-1100 pt-2 pb-0 ps-3">$4630</td>
                  </tr>
                </table>
              </div>
            </div>
