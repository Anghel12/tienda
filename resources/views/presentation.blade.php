...
<body class="presentation-page">
                      ...
                      <div class="col-12 px-4 py-2">
                        <div class="row">
                          <div class="col-4 position-relative">
                            ...
                            <a href="https://demos.creative-tim.com/marketplace/soft-ui-design-system-pro/pages/coworking.html"
                            ...
                            <a href="pages/podcast.html" class="dropdown-item border-radius-md">
                              <span class="ps-3">Podcast <span
                                  class="badge badge-sm bg-gradient-dark ms-1">NEW</span></span>
                            </a>
                            <div
                          ...
                          <div class="col-4">
                            ...
                            <a href="pages/digital-agency.html" class="dropdown-item border-radius-md">
                              <span class="ps-3">Digital Agency <span
                                  class="badge badge-sm bg-gradient-dark ms-1">NEW</span></span>
                            </a>
                      ...
                      <ul class="list-group">
                        <li class="nav-item list-group-item border-0 p-0">
                          <a class="dropdown-item py-2 ps-3 border-radius-md"
                            href=" https://www.creative-tim.com/learning-lab/bootstrap-marketplace/overview/soft-ui-design-system ">
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <li class="nav-item list-group-item border-0 p-0">
                          <a class="dropdown-item py-2 ps-3 border-radius-md"
                            href=" https://www.creative-tim.com/learning-lab/bootstrap-marketplace/colors/soft-ui-design-system ">
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <li class="nav-item list-group-item border-0 p-0">
                          <a class="dropdown-item py-2 ps-3 border-radius-md"
                            href=" https://www.creative-tim.com/learning-lab/bootstrap-marketplace/alerts/soft-ui-design-system ">
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                        ...
                        <li class="nav-item list-group-item border-0 p-0">
                          <a class="dropdown-item py-2 ps-3 border-radius-md"
                            href=" https://www.creative-tim.com/learning-lab/bootstrap-marketplace/utilities/soft-ui-design-system ">
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                                <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1"
                                  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <header class="header-2">
    <div class="page-header min-vh-75 relative" style="background-image: url('assets/img/curved-images/curved1.jpg')">
      <span class="mask bg-gradient-primary"></span>
      <div class="container">
        <div class="row">
          <div class="col-lg-7 text-center mx-auto">
            <h1 class="text-white pt-3 mt-n5">Soft UI Design System Pro</h1>
            <p class="lead text-white mt-3">Simple and innovative Web UI Kit built on top of Bootstrap 5. <br /> Join
      ...
      <div class="row">
        <div class="col-md-7 col-12 my-auto">
          ...
          <p class="pe-md-5 mb-4">
            Do you want to test and see the benefits of this Design System before purchasing it? It features enough
            basic components and sections for you to get a feel of the design and also test the quality of the code. Get
            it free on GitHub!
          </p>
          <div class="github-buttons">
            <a href="https://github.com/creativetimofficial/soft-ui-design-system" target="_blank" rel="nofollow"
              class="btn bg-gradient-primary mb-5 mb-sm-0">View Demo on Github</a>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 me-lg-auto my-lg-auto text-lg-end mt-5">
          <a href="https://twitter.com/intent/tweet?text=Check%20Soft%20UI%20Design%20System%20made%20by%20%40CreativeTim%20%23webdesign%20%23designsystem%20%23bootstrap5&url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-design-system-pro"
            class="btn btn-twitter mb-0 me-2" target="_blank">
            <i class="fab fa-twitter me-1"></i> Tweet
          </a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/soft-ui-design-system-pro"
            class="btn btn-facebook mb-0 me-2" target="_blank">
            <i class="fab fa-facebook-square me-1"></i> Share
          </a>
          <a href="https://www.pinterest.com/pin/create/button/?url=https://www.creative-tim.com/product/soft-ui-design-system-pro"
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-46172202-12">
    aside
  </script>
  <script>
