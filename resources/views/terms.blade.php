...
<section class="pt-3 pt-md-5 pb-md-5 pt-lg-7 bg-gray-200">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#general-terms">
    <div class="icon me-2">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#cookies">
    <div class="icon me-2">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#license">
    <div class="icon me-2">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#hyperlinking">
    <div class="icon me-2">
    <svg class="text-primary" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#iframes">
    <div class="icon me-2">
    <svg class="text-primary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="#">
    <div class="icon me-2">
    ...
    <li class="nav-item">
    <a class="nav-link text-dark" data-scroll href="terms.html#disclaimer">
    <div class="icon me-2">
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Creative Tim does not filter, edit, publish or review Comments prior to their presence on the website.
