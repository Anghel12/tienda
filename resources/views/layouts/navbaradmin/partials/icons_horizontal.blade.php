            ...
            <div class="card position-relative border-0">
              ...
              <div class="overflow-auto scrollbar" style="height: 10rem;">
                <ul class="nav d-flex flex-column mb-2 pb-1">
                  ...
                  <li class="nav-item"><a class="nav-link px-3" href="{{ route('admin.profile.show', Auth::user()->id) }} "> <span class="me-2 text-900" data-feather="settings"></span>Settings &amp; Privacy </a></li>
              ...
              <div class="card-footer p-0 border-top">
                <ul class="nav d-flex flex-column my-3">
                  <li class="nav-item"><a class="nav-link px-3" href="{{ Auth::user()->name }}"> <span class="me-2 text-900" data-feather="user-plus"></span>Add another account</a></li>
                </ul>
                <hr />
